...
public class Renderer {
	...
	public void prepare() {
		/* Checks which triangle is on top of the other one. */
	...
	public void render(Entity entity, StaticShader shader) {
		...
		/* Creates a transformation matrix with the transformation values. */
